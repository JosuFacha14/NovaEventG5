...
@section('content_header')
    <div class="row align-items-center">
        <div class="col-sm-6">
            <h3 class="mb-0"><i class="bi bi-shield-lock me-2"></i>Catálogo — Tipos de Usuario</h3>
        </div>
        ...
        <div class="table-responsive">
            <table id="tblTiposUsr" class="table table-bordered table-hover table-sm align-middle">
                ...
                <tbody>
                    @forelse($tipos as $t)
                        <tr>
                            <td class="text-center fw-bold">{{ $t['COD_TIPO_USR'] }}</td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="bi bi-plus-circle me-1"></i> Nuevo Tipo de Usuario</h5>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const formCrear = document.getElementById('formCrearTipoUsr');
