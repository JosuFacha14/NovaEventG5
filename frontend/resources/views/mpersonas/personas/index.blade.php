                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="primer_nombre" class="form-control" maxlength="255" required
                                       pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+" oninput="this.value = this.value.replace(/[^a-zA-ZáéíóúÁÉÍÓÚñÑ\s]/g, '');">
                                <div class="invalid-feedback">El primer nombre es obligatorio y solo debe contener letras.</div>
                            </div>
