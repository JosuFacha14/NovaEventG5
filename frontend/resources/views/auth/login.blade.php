...
<head>
    ...
    <style>
        ...
        .register-link:hover { text-decoration: underline; color: #b8942a; }
    </style>
</head>
<body>
    <div class="login-card">
        ...
        @if(session('success'))
            <div class="alert alert-success small p-2 text-center mb-3">
                {{ session('success') }}
            </div>
        @endif
        ...
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <div class="field-group">
                <label for="nombre_usr">Usuario</label>
                <div class="input-wrap {{ $errors->has('nombre_usr') ? 'is-invalid' : '' }}">
                    <i class="ti ti-user" aria-hidden="true"></i>
                    <input type="text"
                           id="nombre_usr"
                           name="nombre_usr"
                           value="{{ old('nombre_usr') }}"
