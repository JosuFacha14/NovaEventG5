...
@section('content_header')
    <div class="row align-items-center">
        <div class="col-sm-6">
            <h3 class="mb-0">Catálogo — Tipos de Cliente</h3>
        </div>
        ...
        <div class="table-responsive">
            <table id="tblTiposCli" class="table table-bordered table-hover table-sm align-middle">
                ...
                <tbody>
                    @forelse($tipos as $t)
                        <tr>
                            <td class="text-center">{{ $t['COD_TIPO_CLI'] }}</td>
                            <td><span class="badge bg-primary">{{ $t['NOM_TIPO_CLI'] }}</span></td>
                            <td>{{ $t['DES_TIPO_CLI'] ?? '—' }}</td>
                            <td class="text-center">
                                @if(($t['IND_TIPO_CLI'] ?? '0') === '1')
            ...
            <div class="modal-content">
                ...
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title">
                        <i class="bi bi-plus-circle me-1"></i> Nuevo Tipo de Cliente
                    </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="des_tipo_cli" class="form-control" maxlength="255" required
                                   placeholder="Descripción breve del tipo de cliente">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const form = document.getElementById('formCrearTipoCli');
