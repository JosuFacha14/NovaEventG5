...
Route::prefix('mreportes')->group(function () {
    ...
    Route::put('/costos/baja/{id}', [ReportesController::class, 'darDeBajaCosto'])->name('costos.baja');
    ...
    Route::put('/ganancias/baja/{id}', [ReportesController::class, 'darDeBajaGanancia'])->name('ganancias.baja');
    ...
    Route::put('/inventario/baja/{id}', [ReportesController::class, 'darDeBajaInventario'])->name('inventario.baja');
});